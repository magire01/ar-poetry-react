...
const BioSection = () => {
    ...
    return (
        ...
        <Grid container style={{ marginTop: "5%" }}>
            <Grid item md="6" xs="12" style={{ width: 100, height:"auto", textAlign: "center", marginTop: "3%" }}>
            ...
            <Grid item md="6" xs="12">
                <Typography style={{ paddingRight: 40, paddingLeft: 10, marginTop: "25%", textAlign: "center" }}>
                    I'm from Union, KY. 
                    I like turtles. 
